...
from .views import ClientListView, ClientCreateView, ClientDetailView, ClientUpdateView, ClientDeleteView, \
    MessageTemplateListView, MessageTemplateCreateView, MessageTemplateDetailView, MessageTemplateUpdateView, \
    MessageTemplateDeleteView, CampaignListView, CampaignCreateView, CampaignDetailView, CampaignUpdateView, \
    CampaignDeleteView, CampaignAttemptListView, CampaignAttemptDetailView
